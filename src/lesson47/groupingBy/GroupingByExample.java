package lesson47.groupingBy;

import java.util.*;
import java.util.stream.Collectors;

import static lesson47.StreamExample.task1;

public class GroupingByExample {

    /*
    Collectors.groupingBy(Function classifier) - простейшая форма группировки
    Группирует по ключу,полученному с помощью ф-ции классификатора
